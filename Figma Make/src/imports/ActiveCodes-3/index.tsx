import svgPaths from "./svg-x2bjt4cvlt";
...
function Group4() {
  return (
    <div className="absolute contents left-[42px] top-[608px]">
      <div className="absolute bg-white border border-[#d9d9d9] border-solid h-[144px] left-[42px] opacity-30 rounded-[10px] shadow-[0px_1px_5px_0px_rgba(0,0,0,0.25)] top-[608px] w-[146px]" />
      <div className="absolute left-[72px] opacity-30 size-[85px] top-[616px]" data-name="image 13">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage16} />
      </div>
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Poppins:SemiBold',sans-serif] leading-[normal] left-[114.5px] not-italic opacity-30 text-[#7d7f7e] text-[8px] text-center top-[733px] w-[109px]">Valid until: 10-10-2025</p>
      <div className="absolute bg-white border border-[#007bc1] border-solid h-[14px] left-[86px] opacity-30 rounded-[10px] top-[710px] w-[57px]" />
      <p className="[word-break:break-word] absolute font-['Poppins:Medium',sans-serif] leading-[normal] left-[102px] not-italic opacity-30 text-[#002540] text-[8px] top-[711px] whitespace-nowrap">10 pts</p>
    </div>
  );
}
...
export default function ActiveCodes() {
  return (
    <div className="bg-white relative size-full" data-name="Active Codes">
      <Orders />
