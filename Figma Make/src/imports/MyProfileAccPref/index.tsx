import svgPaths from "./svg-jg52gs4jh5";
...
function Group() {
  return (
    <div className="absolute contents left-[109px] top-[423px]">
      <div className="absolute left-[394px] overflow-clip size-[28px] top-[423px]" data-name="X circle" />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Poppins:SemiBold',sans-serif] h-[18px] justify-center leading-[0] left-[109px] not-italic text-[12px] text-white top-[766px] w-[66px]">
        <p className="leading-[16px]">Total Paid</p>
      </div>
    </div>
  );
}
...
function Switch() {
  return (
    <div className="h-[24px] relative shrink-0 w-[40px]" data-name="Switch">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 24">
        <g id="Switch">
          <mask fill="white" id="path-1-inside-1_2009_3224">
            <path d={svgPaths.p16cbda00} />
          </mask>
          <path d={svgPaths.p16cbda00} fill="var(--fill-0, #007BC1)" />
          <path d={svgPaths.p153870c0} fill="var(--stroke-0, #007BC1)" mask="url(#path-1-inside-1_2009_3224)" />
          <path d={svgPaths.p27840e00} fill="var(--fill-0, #F5F5F5)" id="Knob" />
        </g>
      </svg>
    </div>
  );
...
function Switch2() {
  return (
    <div className="h-[24px] relative shrink-0 w-[40px]" data-name="Switch">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 24">
        <g id="Switch">
          <mask fill="white" id="path-1-inside-1_2009_3221">
            <path d={svgPaths.p16cbda00} />
          </mask>
          <path d={svgPaths.p16cbda00} fill="var(--fill-0, white)" />
          <path d={svgPaths.p153870c0} fill="var(--stroke-0, #757575)" mask="url(#path-1-inside-1_2009_3221)" />
          <path d={svgPaths.p2703f600} fill="var(--fill-0, #757575)" id="Knob" />
        </g>
      </svg>
    </div>
  );
...
function Group2() {
  return (
    <div className="absolute contents left-[51px] top-[375px]">
      <Group1 />
      <div className="absolute bg-[#f2f2f2] h-[48px] left-[51px] rounded-[12px] top-[375px] w-[347px]" />
      <div className="absolute bg-[#f2f2f2] h-[48px] left-[51px] rounded-[12px] top-[437px] w-[347px]" />
      <p className="[word-break:break-word] absolute font-['Poppins:SemiBold',sans-serif] leading-[normal] left-[63px] not-italic text-[12px] text-black top-[392px] whitespace-nowrap">Email Notifications</p>
      <p className="[word-break:break-word] absolute font-['Poppins:SemiBold',sans-serif] leading-[normal] left-[63px] not-italic text-[12px] text-black top-[454px] whitespace-nowrap">Phone Notifications</p>
      <div className="absolute content-stretch flex flex-col h-[24px] items-start left-[339px] top-[389px] w-[40px]" data-name="Switch Field">
        <CheckboxAndLabel />
      </div>
      <div className="absolute bg-[#f2f2f2] h-[48px] left-[51px] rounded-[12px] top-[499px] w-[347px]" />
      <p className="[word-break:break-word] absolute font-['Poppins:SemiBold',sans-serif] leading-[normal] left-[63px] not-italic text-[12px] text-black top-[516px] whitespace-nowrap">2FA Security</p>
      <div className="absolute content-stretch flex flex-col h-[24px] items-start left-[339px] top-[513px] w-[40px]" data-name="Switch Field">
        <CheckboxAndLabel1 />
      </div>
      <div className="absolute content-stretch flex flex-col h-[24px] items-start left-[337px] top-[451px] w-[40px]" data-name="Switch Field">
        <CheckboxAndLabel2 />
      </div>
    </div>
  );
...
function Group3() {
  return (
    <div className="absolute contents left-[31px] top-[301px]">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Poppins:SemiBold',sans-serif] leading-[normal] left-[112px] not-italic text-[#7d7f7e] text-[10px] text-center top-[301px] w-[122px]">Personal Details</p>
      <p className="[word-break:break-word] absolute font-['Poppins:SemiBold',sans-serif] leading-[normal] left-[268px] not-italic text-[#007bc1] text-[10px] top-[301px] w-[108px]">Account Preferences</p>
      ...
      <div className="absolute flex h-[0.483px] items-center justify-center left-[221px] top-[319px] w-[189px]">
...
export default function MyProfileAccPref() {
  return (
    <div className="bg-white relative size-full" data-name="My Profile - Acc Pref">
      <Orders />
      ...
      <p className="[word-break:break-word] absolute font-['Poppins:Bold',sans-serif] leading-[normal] left-[51px] not-italic text-[#007bc1] text-[16px] top-[336px] whitespace-nowrap">Account Preferences</p>
