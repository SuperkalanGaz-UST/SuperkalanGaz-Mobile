import svgPaths from "./svg-05lhf5j6x4";
...
function PopUp() {
  return (
    <div className="absolute contents left-px top-[774px]" data-name="Pop up">
      <div className="absolute bg-white h-[191px] left-px rounded-tl-[20px] rounded-tr-[20px] top-[774px] w-[439px]" />
      <p className="[word-break:break-word] absolute font-['Poppins:SemiBold',sans-serif] leading-[normal] left-[25px] not-italic text-[#044674] text-[20px] top-[802px] whitespace-nowrap">Get Your Free Notebook and Pen</p>
      <a className="absolute bg-[#007bc1] block cursor-pointer h-[47px] left-[40px] rounded-[10px] top-[890px] w-[354px]" />
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Poppins:SemiBold',sans-serif] leading-[normal] left-[215.5px] not-italic text-[15px] text-center text-white top-[902px] w-[147px]">REDEEM</p>
      <div className="absolute left-[402px] overflow-clip size-[16px] top-[786px]" data-name="X">
      ...
      <div className="absolute bg-white border border-[#007bc1] border-solid h-[22px] left-[25px] rounded-[10px] top-[843px] w-[97px]" />
      <p className="[word-break:break-word] absolute font-['Poppins:Medium',sans-serif] leading-[normal] left-[58px] not-italic text-[#002540] text-[10px] top-[846px] whitespace-nowrap">10 pts</p>
    </div>
  );
}
...
export default function Redeem() {
  return (
    <div className="bg-white relative size-full" data-name="Redeem">
      <Orders />
